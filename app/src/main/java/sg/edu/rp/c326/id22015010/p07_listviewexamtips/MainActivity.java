package sg.edu.rp.c326.id22015010.p07_listviewexamtips;
...
ArrayAdapter<String> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTipsArray[1]="Seek help from the lecturer ASAP, " +
                "don't wait till you lost in the jungle.";
        ...
        //This one below will then not need ArrayAdapter<String> adapter; above the @Override
        //ArrayAdapter adapter = new ArrayAdapter<>
        //        (this, android.R.layout.simple_list_item_1, examTipsArray);
